export default {
  ...
  onlyAudits: [
    'first-contentful-paint','speed-index','largest-contentful-paint','total-blocking-time',
    'cumulative-layout-shift','dom-size','unminified-javascript','efficient-animated-content',
    'errors-in-console',
    'uses-responsive-images','viewport','offscreen-images','uses-optimized-images',
    'unused-css-rules','unused-javascript','meta-viewport','font-size',

    'total-byte-weight','is-on-https','uses-http2','form-field-multiple-labels',
  ...
  categories: {
    ...
    'best-practices': {
      auditRefs: [
        { id: 'is-on-https', weight: 1, group: 'best-practices' }, // HTTPS security
        { id: 'uses-http2', weight: 1, group: 'best-practices' }, // No security vulnerabilities (example)
        { id: 'form-field-multiple-labels', weight: 1, group: 'best-practices' }, // Placeholder for form privacy
      ],
    },
